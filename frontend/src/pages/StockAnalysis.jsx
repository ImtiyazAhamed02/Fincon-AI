      ...
      <div className="px-6 py-5 flex items-center justify-between"
        ...
        <div className="flex items-center space-x-4">
          ...
          <div>
            ...
            <p className="text-xs text-slate-500 mt-0.5">News → Technical → Risk → Fundamental → Portfolio → CIO recommendation</p>
          </div>
        </div>
        <div className="flex items-center space-x-3">
          {rec && (
          ...
          <button
            ...
            className="btn-primary flex items-center space-x-2 disabled:opacity-30"
          >
            {loading
