    ...
    def analyze_news(self, ticker: str) -> dict:
        ...
        task = Task(
            description=(
                ...
                f"RULE 6: List every excluded article in a table with its exclusion reason from the tool."
            ),
            expected_output=(
                ...
                f"---\n"
                f"## ✅ Relevant Articles Analyzed\n"
                f"| # | Headline | Source | Who Benefits | Classified As |\n"
                f"| --- | --- | --- | --- | --- |\n"
                f"*[List each article from recent_articles field, showing primary_beneficiary and sentiment columns]*\n\n"
                f"---\n"
                f"## 😊 Good News\n"
                ...
                f"---\n"
                f"## 🚫 Articles We Skipped\n"
                f"These articles were removed because they are not directly about {ticker}:\n\n"
                f"| # | Article | Source | Why We Skipped It |\n"
                f"| --- | --- | --- | --- |\n"
                f"*[List each excluded_article with its reason field from the tool]*\n\n"
                f"---\n"
                f"## 📋 Bottom Line\n"
    ...
    def analyze_stock(self, company: str, ticker: str) -> dict:
        ...
        news_task = Task(
            ...
            expected_output=(
                ...
                f"---\n"
                f"## 🚫 Articles We Skipped\n"
                f"These articles were removed because they are not directly about {company}:\n\n"
                f"| # | Article | Source | Why We Skipped It |\n"
                f"| --- | --- | --- | --- |\n"
                f"*[List each excluded_article with its reason field from the tool]*\n\n"
                f"---\n"
